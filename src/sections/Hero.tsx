      ...
      <div className="relative @container container mx-auto px-4 md:pt-12 pt-8 ">
        <div className=" flex flex-col md:flex-row items-center sm:gap-12">
          <div className=" flex-1 space-y-6">
            ...
            <Fade direction="left" cascade damping={0.2} duration={800} triggerOnce>
              <div className="inline-block text-sm text-purple-600">
                150+ Vendors
              </div>
          ...
          {/* Image Card Section */}
          <Fade direction="right" duration={800} className="relative transform sm:-translate-x-[5%] translate-x-[5%] flex-1 h-[480px] flex justify-center md:justify-end items-end max-lg:scale-[0.85] @max-[425px]:scale-[0.70] " triggerOnce>
            <div >
              {/*floating icons */}
              <div className="absolute right-80 md:top-5 -top-15 z-20 w-14 h-14 rounded-full flex justify-center items-center  backdrop-blur-md shadow-lg border border-white/50 animate-bounce">
