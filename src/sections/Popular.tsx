                ...
                >
                  ...
                  <div className="sm:h-48 h-34 relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-end opacity-0 group-hover:opacity-100 group-active:opacity-100 duration-300 transition-all  bg-gradient-to-t from-black/60 to-transparent">
                      <div
                        className={`px-2 py-1 m-4 rounded-full text-white text-xs ${popular.productsColor}`}
                      >
                  ...
                  <div className="p-4 flex flex-col flex-grow">
                    ...
                    <p className="opacity-70 sm:mb-3 mb-2 flex-grow">
                      {popular.description}
                    </p>
                    <a className="flex items-center gap-2 text-purple-600 group-hover:underline group-active:underline">
                      Explore{" "}
